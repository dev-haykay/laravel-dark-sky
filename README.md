...
[![StyleCI](https://github.styleci.io/repos/148543382/shield?branch=5.5&style=flat)](https://github.styleci.io/repos/148543382)
[![Build Status](https://travis-ci.com/dmitry-ivanov/laravel-dark-sky.svg?branch=5.5)](https://travis-ci.com/dmitry-ivanov/laravel-dark-sky)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-dark-sky/badge.svg?branch=5.5)](https://coveralls.io/github/dmitry-ivanov/laravel-dark-sky?branch=5.5)
...
1. Install the package via Composer:
    ...
    ```shell
    composer require "illuminated/dark-sky:5.5.*"
    ```
